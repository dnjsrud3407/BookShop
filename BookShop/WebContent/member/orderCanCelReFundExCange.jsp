...
<!-- Sidebar end=============================================== -->
    ...
    <ul class="breadcrumb">
		...
		<li class="active">교환/반품/취소 내역</li>
    </ul>
	<h3>교환/반품/취소 내역</h3>	
	<br>
...
<c:set value="0" var="pointValue"></c:set>
                   <c:if test="${empty orderCanCelReFundExCange}">
						<h5>검색결과가 없습니다</h5>
				   </c:if>
<!-- //--------------ㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡㅡ------------------------------------------------------    -->
<c:if test="${orderCanCelReFundExCange!=null}">
	<c:forEach var="list" items="${orderCanCelReFundExCange}" varStatus="status">
